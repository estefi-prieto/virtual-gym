defmodule VirtualGymWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VirtualGymWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VirtualGymWeb.Gettext, "errors", msg, opts)
    end
  end
